...
const BOOLEAN_SIGNALS = new Set(["smart_wallets_present", "discord_active"]);

// Categorical signals — compared by win rate across categories
const CATEGORICAL_SIGNALS = new Set(["narrative_quality", "fragility_level", "lpagent_confidence"]);
...
export function scoreCandidateWithWeights(candidate, weightsObj = null) {
  ...
  const fields = {
    ...
    x_narrative_score: candidate.x_narrative_score ?? candidate.x_narrative?.x_narrative_score,
  };
  let score = 0;
  let used = 0;
