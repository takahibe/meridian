...
Screening: screeningSource, minFeeActiveTvlRatio, minTvl, maxTvl, minVolume, minOrganic, minQuoteOrganic, minHolders, minMcap, maxMcap, minBinStep, maxBinStep, timeframe, screeningTimeframe, entryTimeframe, category, minTokenFeesSol, excludeHighSupplyConcentration, allowedLaunchpads, blockedLaunchpads
GMGN (persisted to gmgn-config.json): gmgnApiKey, gmgnBaseUrl, gmgnInterval, gmgnPoolDetailTimeframe, gmgnEntryTimeframe, gmgnOrderBy, gmgnDirection, gmgnLimit, gmgnEnrichLimit, gmgnRequestDelayMs, gmgnMaxRetries, gmgnFilters, gmgnPlatforms, gmgnMinMcap, gmgnMaxMcap, gmgnMinVolume, gmgnMinHolders, gmgnMinTokenAgeHours, gmgnMaxTokenAgeHours, gmgnAthFilterPct, gmgnMaxBundlerRate, gmgnMaxFreshWalletRate, gmgnMaxDevTeamHoldRate, gmgnPreferredKolNames, gmgnPreferredKolMinHoldPct, gmgnRequireKol, gmgnMinKolCount, gmgnMinSmartDegenCount, gmgnMinTotalFeeSol
...
- Copy-paste of another token's narrative`,
...

  {
    type: "function",
    function: {
      name: "get_x_narrative",
      description: `Query X recent-search narrative signals for a token using symbol and/or contract.
Returns confidence band, posting velocity, author quality, and coordinated shill-burst detection.
Use this as the hard narrative gate in funnel screening when you need live X evidence.`,
      parameters: {
        type: "object",
        properties: {
          symbol: { type: "string", description: "Token symbol/ticker, e.g. BONK" },
          contract: { type: "string", description: "Token mint / contract address" },
          mint: { type: "string", description: "Alias for contract" }
        }
      }
    }
  },
